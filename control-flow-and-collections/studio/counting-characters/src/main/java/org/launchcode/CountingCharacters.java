...
public class CountingCharacters {
    public static void main(String[] args) {
        ...
        for (char singleCharacters : charsInString){
            if(characterCounts.containsKey(singleCharacters)){
                characterCounts.put(singleCharacters, characterCounts.get(singleCharacters) +1);
            }
            else{
                characterCounts.put(singleCharacters, 1);
            }
        }
